...
case $gmp_cv_option_alloca in
  alloca)
	...
	dnl ==================================================================
	dnl Change extension to $O to support the Intel SGX build, which can't
	dnl use libtool. $O is set in configure.ac.
	dnl - John Mechalas <john.p.mechalas@intel.com>
