...
union YYSTYPE
{
#line 142 "calc.y" /* yacc.c:355  */

  char  *str;
  int   var;

#line 312 "calc.c" /* yacc.c:355  */
};
...
static const char *const yytname[] =
{
  ...
  "'/'", "'%'", "UMINUS", "'^'", "'!'", "'='", "'('", "')'", "','",
  "$accept", "top", "statements", "statement", "e", "gcdlist", "lcmlist", YY_NULLPTR
};
#endif
